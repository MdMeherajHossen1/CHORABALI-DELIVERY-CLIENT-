    ...
    return (
        <div className="container">
            <div className="row g-4">
                <div className="col-md-5 mx-auto mt-4 col-11">
                    <form className="py-4">
                    ...
                    <button onClick={signInGoogle} class="btn btn-dark col-12 text-white"  > <img src={'https://i.ibb.co/CWPNzBr/Google-Symbol-1.png'} style={{ height: "30px" }} alt="" /> Sign up with Google</button>
                </div>
